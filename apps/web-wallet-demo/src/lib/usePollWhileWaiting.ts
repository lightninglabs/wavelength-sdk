...
// for its CSV timelock, which is hours to days, so an unbounded poll would hammer
// the daemon for the life of the app. Give up after roughly ten minutes and let
// the manual refresh take over.
