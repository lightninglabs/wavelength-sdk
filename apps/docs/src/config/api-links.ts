...
const coreSymbols = [
  ...
  'EntryRequestType', 'exit', 'exitStatus', 'getExitPlan', 'sweepWallet', 'callRaw',
  ...
  'ExitStatusResult', 'ExitJobStatus', 'GetExitPlanRequest', 'GetExitPlanResult',
  'ExitPlanEntry', 'SweepWalletRequest', 'SweepWalletResult', 'WalletSweepInput',
