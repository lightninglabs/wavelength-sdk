...
<ApiSymbol name="WavelengthProvider" kind="class">
...
<ParamsTable rows={[
  { name: 'phase', type: 'RuntimePhase', desc: 'Current runtime/wallet lifecycle phase. See RuntimePhase on the wavelength-core reference; note it now includes \'restoring\'.' },
