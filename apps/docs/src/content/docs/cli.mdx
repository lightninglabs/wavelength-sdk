...
| `3` | auth failure | The daemon rejected the call as unauthenticated or not permitted (a missing or invalid macaroon). A wrong password and a locked wallet both report `2` instead; see the mapping below. |
