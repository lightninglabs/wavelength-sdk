---
title: darepocli
description: The command-line client for the wallet daemon. It issues gRPC calls to a running darepod and prints structured JSON suitable for humans and agents.
---

import Callout from '~/components/mdx/Callout.astro';

`darepocli` is the command-line client for the wallet daemon (`darepod`). It
...
```json
{
  "error": {
    "code": "WALLET_LOCKED",
    "message": "wallet is locked; run `darepocli unlock`",
    "details": ""
  }
}
```
...
| [`swap`](/cli/swap/) | Lightning swap session operations (build-tag gated). |
