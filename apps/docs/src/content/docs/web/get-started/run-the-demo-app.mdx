...
**signet** wallet out of the box: the connect screen preselects signet, using
the demo's own signet preset (`signetDefaults` in
...
produce. No local backend is needed.
