...
<Callout type="note">
See [Unilateral exit](/web/guides/unilateral-exit/) for a walkthrough of building the flow end to end, or [Handle phases and errors](/web/guides/handle-phases-and-errors/) for surfacing `WalletDKErrorCode` failures along the way.
</Callout>
