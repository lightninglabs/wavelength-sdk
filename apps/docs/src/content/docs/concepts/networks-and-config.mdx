...
description: How to configure the Wavelength SDK for signet, testnet, testnet4, or mainnet with flat RuntimeConfig fields, defaultConfig presets, and platform-specific endpoints.
---
