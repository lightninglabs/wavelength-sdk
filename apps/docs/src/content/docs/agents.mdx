...
Your coding agent can do most of a Wavelength integration for you. This page
...
## Add Wavelength to your AGENTS.md
...
Wavelength embeds a self-custodial Lightning wallet in this app: Lightning
...
- Web: create the engine with createWebWalletEngine() and inject it via
  <WavelengthProvider engine={...}>. Never import walletdk-web from
...
```text
Write automation for the Wavelength wallet using darepocli.
