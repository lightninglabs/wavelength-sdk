...
pnpm --filter @lightninglabs/wavelength-react-native run fetch-bindings           # stage gomobile binaries; needs WAVELENGTH_DIR
...
(needs `WAVELENGTH_DIR`; see the demo README and the script header).
