// gen-types.mts regenerates packages/core/src/generated.ts from the wavelength
// daemon's wavewalletdk facade types (sdk/wavewalletdk), the source of truth for
// the daemon's JSON wire shapes. It runs tygo (Go struct -> TS) then
// post-processes the output to (1) camelCase field names via the shared
// camelKey, and (2) rebuild string/int literal unions for the enums tygo
// flattens to bare aliases.
//
